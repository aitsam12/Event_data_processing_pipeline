...
if __name__ == '__main__':
    ...
    cpp_executable_path = '/home/aitsam/openeb/pipeline/cpp_samples/metavision_evt2_raw_file_encoder/build/metavision_evt2_raw_file_encoder'  # Update with actual path
