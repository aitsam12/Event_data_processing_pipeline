...
def convert_csv_to_raw(csv_file, raw_output_file):
    ...
    executable_path = '/home/aitsam/openeb/pipeline/cpp_samples/metavision_evt2_raw_file_encoder/build/metavision_evt2_raw_file_encoder'  # Adjust this path to where your executable is located
