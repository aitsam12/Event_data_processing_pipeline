...
if __name__ == '__main__':
    ...
    csv_output_path = '/media/aitsam/46F516C5276E2490/DATASETS_pipeline/DVSgesture/extract/checking/new/final22_cd_output2.csv'
    npz_file_path = '/media/aitsam/46F516C5276E2490/DATASETS_pipeline/DVSgesture/extract/checking/new/final22_output.npz'  # Path for the output NPZ file
    bin_file_path = '/media/aitsam/46F516C5276E2490/DATASETS_pipeline/DVSgesture/extract/checking/new/final22_output.bin'  # Path for the output NPZ file
